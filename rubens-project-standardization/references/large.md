...
- Auto-imports are fewer because the standards live in `README.md` and the research paper, not duplicated into `AGENTS.md`.
...
├── AGENTS.md                          ← team, milestones, standards-stack reference, @imports
