...
- sbx-flow.md workflow doc: the OpenCode Runner pipeline from Plane issue to sandboxed opencode run to agent-authored PR (board contract, dispatch split, watchdog/self-heal, bridge, failure paths, infra).
