...
- Streams run: A (arxiv), B (web), C (local)
- Search terms used: ...
- Limits / flags: <e.g. "stream B returned mostly vendor blogs - bias toward commercial perspectives">
- Re-run command: <slug + "standard depth" would re-gather on date X>
