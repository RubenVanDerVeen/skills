...
| [`note-syntax`](./skills/note-syntax/SKILL.md) | Full note-writing syntax for the Hermes Console vault (06_notes): YAML frontmatter, wikilinks, `{N%}` image sizing, file embeds, `columns`/`plot`/`mermaid` fences, KaTeX math. Cheatsheets per topic. |
