...
## 1. The integrated picture

<3-5 sentences. The honest summary for the user. Lead with the strongest conclusion, name the demo-vs-deployment gap if it exists, do not oversell.>
...
**Conflict 1: <subagent A says X, subagent B says Y>**

**Resolution:** <which is right, why, what to cite or not cite in the dossier.>

**Conflict 2:** ...

**Conflict 3:** ...

## 6. The most important claim that NO source explicitly made

<2-3 paragraphs. State the narrative claim. The signals that support it. Why it is a meta-claim rather than a factual one. Confidence level.>
...
|---|---|
| Source coverage (academic) | |
| Source coverage (industry) | |
| Source coverage (critique) | |
| Bias awareness | |
...
<One sentence: what this dossier would need to become a real <dissertation chapter / production deployment decision / paper>.>

---

**Note for the dossier:** <2-3 sentences. Where to lead. Which section to elevate. What to demote.>
